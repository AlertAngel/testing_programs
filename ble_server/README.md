...
This is the code to create a basic BLE Server to share data to a BLE client

## Terminal Output (BLE Server)

![terminal](https://vhs.charm.sh/vhs-1DynBgLSFb78DkcoulLhG7.gif)
